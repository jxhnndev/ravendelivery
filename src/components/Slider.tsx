...
const Slider = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] lg:flex-row bg-lightGold">
      {/* TEXT CONTAINER */}
      <div className="flex-1 flex items-center justify-center flex-col gap-8 text-gold font-bold">
        <h1 className="text-5xl text-center uppercase p-4 md:p-10 md:text-6xl xl:text-7xl">
          {data[currentSlide].title}
        </h1>
        <button className="bg-chelseaBlue text-white py-4 px-8 rounded-md hover:bg-gold duration-500">Order Now</button>
      </div>
      {/* IMAGE CONTAINER */}
