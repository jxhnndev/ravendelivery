    ...
    <section className="py-6 text-chelseaBlue h-screen">
        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x md:py-28">
            <div className="py-6 md:py-0 md:px-6">
                ...
                <p className="pt-2 pb-4">Form is not functional yet</p>
            ...
            <form  className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                ...
                <button type="button" className="self-center px-8 py-3 text-lg rounded bg-gold text-gray-100 hover:bg-chelseaBlue duration-500">Submit</button>
            </form>
        </div>
    </section>
  )
